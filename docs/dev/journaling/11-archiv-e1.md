...
wird nicht gelesen — und `06-status.md` ist laut `README.md` das verbindliche Dokument. Der Inhalt ist
**unverändert** übernommen, nichts gekürzt.

**Was hier _nicht_ steht und weiter in den laufenden Dokumenten gilt:**
