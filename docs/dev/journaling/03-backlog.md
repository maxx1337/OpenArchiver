...
**Warum nicht in E13:** Refaktorierung, keine Sicherheitskorrektur — sie berührt die Middleware, alle
vier `FilterBuilder`-Aufrufstellen und die Service-Signaturen. In einem Epic, dessen Zweck das
Schließen einer Autorisierungslücke ist, würde sie den Diff verwässern und die Abnahme aus `JR-1309`
erschweren. `JR-1310` zählt ausdrücklich **nicht** zu den Kriterien von `JR-1309`.
