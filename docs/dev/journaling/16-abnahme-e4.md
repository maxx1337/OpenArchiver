...
| JR-4-17          | ADR-030: zweite Kette in einer Transaktion → `452 4.5.3`                      | `smtp-server.ts:2253-2280` — zwei Stellen bestätigt, Text unterscheidbar von F55s eigenem `452`                                                                                                                                                                                                                                                                                                                                                                                                                              | erfüllt |
