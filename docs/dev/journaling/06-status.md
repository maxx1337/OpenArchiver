...
**Letzte Aktualisierung:** 2026-07-29 (E13 implementiert, Suite grün — Abnahme `JR-1309` offen) ·
**Branch:** `claude/journaling-e13-iam-hardening` (Epic-Branch, abgezweigt bei `efea6bc`)

> **Alle Fix-Tasks von E13 sind umgesetzt und die Suite ist grün:** `pnpm test` ⇒
> **224 passed | 2 skipped**, Exit **0**. `JR-1301` (rote Tests), `JR-1303`, `JR-1302`, `JR-1304`,
> `JR-1305`, `JR-1306` erledigt. **Offen in E13: `JR-1307` (Betreiberdoku + ADR-016), `JR-1308`
> (Upstream-Entwurf), `JR-1309` (unabhängige Abnahme).** Die Abnahme muss in einer **eigenen Session**
> laufen — E13 ist noch **nicht** abgenommen und **nicht** zurückgemergt.
>
...
> **F3**, **F7**, **F8**, **F22**), offen bleiben **F17**, **F18**, **F23**, **F24**.
>
> `predefined-roles.int.test.ts` ist **grün geblieben** (alle 7 Fälle, TAP-Nachweis je Fall) — der
> Nachweis, dass eine Standardinstallation sich durch die Fixes nicht ändert.
...
| 2           | E13  | IAM-Autorisierung härten           | **in Arbeit** — Suite grün, Abnahme offen                        | 6 / 9           |
