...
| 5           | E4   | `smtp-ingress`-Service             | in Arbeit (`JR-4-01`, `JR-4-02`, `JR-4-03`, `JR-4-16`, `JR-4-04`, `JR-4-05a`, `JR-4-05b` erledigt, DEV; die letzten beiden vom PO mit eigenem Volllauf geprüft) | 6 / 17 (+ `JR-4-05a`/`JR-4-05b` als erste zwei von drei `JR-4-05`-Scheiben) |
...
115 Tasks in den Epics (E0 lieferte 102; E13 kam mit 9 hinzu, E4 mit 4: `JR-4-14` und `JR-4-15` als
Auflagen aus **ADR-026**, `JR-4-16` für **F44**, `JR-4-17` für **ADR-027**). Dazu **`JR-13-10`** als Folge-Task nach
