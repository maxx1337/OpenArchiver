...
**Letzte Aktualisierung:** 2026-07-31 (**E2 hat begonnen: `JR-203`, `JR-201` und `JR-202` sind erledigt —
ADR-006 entschieden, `packages/journaling` existiert, die kanonische Kodierung trifft die Testvektoren**) ·
**Branch:** `claude/journaling-e2-ledger`, abgezweigt vom Integrationsbranch (E13 ist zurückgemergt)
