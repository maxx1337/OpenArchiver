...
**Letzte Aktualisierung:** 2026-07-31 (**E2 läuft: `JR-201`…`JR-207` sind erledigt — ADR-006 und ADR-009
entschieden, die Kette wird geschrieben, verifiziert sich nach dem Datenbank-Rundtrip, und die
Steckbarkeit des Ledger-Backends ist gemessen. Offen: `JR-208`/`JR-209` (TEST) und die Abnahme
