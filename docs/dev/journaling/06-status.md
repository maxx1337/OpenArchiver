...
| 5           | E4   | `smtp-ingress`-Service             | in Arbeit (`JR-4-01`, `JR-4-02`, `JR-4-03`, `JR-4-16`, `JR-4-04`, `JR-4-05a` erledigt, DEV, ungeprüft) | 5 / 16 (+ `JR-4-05a` als erste von drei `JR-4-05`-Scheiben) |
